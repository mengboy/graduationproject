...
public class NewsController {
    ...
    @GetMapping("")
    @RequiresPermissions("content:news:news")
    String newsType(){
     ...
     */
    @PostMapping("/add")
    @RequiresPermissions("content:news:add")
    @ResponseBody
    ...
    @PostMapping("/edit")
    @RequiresPermissions("content:news:edit")
    @ResponseBody
    ...
    @PostMapping("/remove")
    @RequiresPermissions(("content:news:remove"))
    @ResponseBody
    ...
    @RequiresPermissions(("content:news:batchRemove"))
    @ResponseBody

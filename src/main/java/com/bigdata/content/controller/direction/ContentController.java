...
import com.bigdata.content.service.DirectionShowProject;
...
public class ContentController {
    ...
    String addDiscussSpace(){
        return "content/direction/addDiscussSpace";
    }
    ...
    String addCaseAnalysis(){
        return "content/direction/addCaseAnalysis";
    }


    @GetMapping("/addShowProjectPage")
    String addShowProjectPage(){
        return "content/direction/addShowProject";
    }
    ...
    @ResponseBody
    @RequiresPermissions("content:direction:contentadd")
    ...
    String edit(@PathVariable("did") Integer did, Model model) {
        ...
        return "content/direction/editShowProject";
    }
